...
<h7 align="left"><p style="color: rgba(0, 0, 0, 0.3);">MDS 5110 NLP Proposal for Final Project - Group 38: Guyuan XU 224040074</p>
...
This tutorial consists of 7 chapters (maybe more in the future), each chapter are written in a ready-to-run `.ipynb` together with markdown notes. You can choose:

- read all `.ipynb` from https://xuguy.github.io/
- `git clone https://github.com/xuguy/xuguy.github.io.git` (<4.5 MB) read and run all `.ipynb` locally (with `PyTorch >= 2.6.0`)
